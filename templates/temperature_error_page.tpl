        ...
        <div class="ui text container">
            ...
            <p>
                <div class="ui error message">
                    ...
                    <p>Сервер просил передать, что значение температуры в таблице {{ inc_table }} его не устраивает. Пожалуйста, проверьте корректность введенных данных и повторите попытку.</p>
                </div>
            </p>
        </div>
